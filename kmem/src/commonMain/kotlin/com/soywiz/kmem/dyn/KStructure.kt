...
open class LayoutBuilder {
    ...
    private fun align(size: Int): LayoutBuilder {
    ...
    fun bool() = DelegateBoolProperty(alloc(Int.SIZE_BYTES))
    fun int() = DelegateIntProperty(alloc(Int.SIZE_BYTES))
    fun long() = DelegateLongProperty(alloc(Long.SIZE_BYTES))
    fun float() = DelegateFloatProperty(alloc(4))
    fun double() = DelegateFloatProperty(alloc(8))
    fun nativeFloat() = DelegateNativeDoubleProperty(alloc(POINTER_SIZE))
    fun nativeLong() = DelegateNativeLongProperty(alloc(LONG_SIZE))
    fun kpointer() = DelegateKPointerProperty(alloc(POINTER_SIZE))
    fun <T> pointer() = DelegatePointerProperty<T>(alloc(POINTER_SIZE))
}
...
inline class DelegateBoolProperty(val offset: Int) {
...
inline class DelegateLongProperty(val offset: Int) {
...
inline class DelegateKPointerProperty(val offset: Int) {
