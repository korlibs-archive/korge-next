...
val Project.isSample: Boolean get() = project.path.startsWith(":samples:") || project.path.endsWith("-sample")
...
subprojects {
    ...
    if (doConfigure) {
        val isSample = project.path.startsWith(":samples") || project.path.endsWith("-sample")
