...
inline operator fun KMutableProperty0<IPoint>.get(path: VectorPath, includeLastPoint: Boolean = true): V2<IPoint> = this[path.getCurves().getEquidistantPoints().also {
