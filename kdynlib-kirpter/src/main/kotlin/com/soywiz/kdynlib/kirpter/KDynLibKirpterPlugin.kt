package com.soywiz.kdynlib.kirpter
...
class KDynLibKirpterPlugin : KirpterPlugin {
    override fun createGeneratorExtension(context: KirpterContext): IrGenerationExtension? =
        KDynLibIrGenerationExtension(context)
}

class KDynLibIrGenerationExtension(
    val context: KirpterContext,
) : IrGenerationExtension {
    private val messageCollector: MessageCollector get() = context.messageCollector
