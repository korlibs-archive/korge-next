...
public class ObjectFloatMap<K> implements Iterable<ObjectFloatMap.Entry<K>> {
    ...
    static public class Values extends MapIterator<Object> {
        ...
        public JFloatArray toArray () {
            JFloatArray array = new JFloatArray(true, map.size);
            while (hasNext)
                array.add(next());
            return array;
        }
        ...
        public JFloatArray toArray (JFloatArray array) {
            while (hasNext)
                array.add(next());
            return array;
        }
    ...
    static public class Keys<K> extends MapIterator<K> implements Iterable<K>, Iterator<K> {
        ...
        public JArray<K> toArray () {
            return toArray(new JArray<K>(true, map.size));
        }
