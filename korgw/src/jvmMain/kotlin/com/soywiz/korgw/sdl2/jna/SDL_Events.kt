...
open class SDL_AudioDeviceEvent(pointer: Pointer? = null) : Structure(pointer) {
    @JvmField var type: Uint32 = 0
    @JvmField var timestamp: Uint32 = 0
    @JvmField var which: Uint32 = 0
    @JvmField var iscapture: Uint8 = 0
    @JvmField var padding1: Uint8 = 0
    @JvmField var padding2: Uint8 = 0
    @JvmField var padding3: Uint8 = 0
...
open class SDL_ControllerAxisEvent(pointer: Pointer? = null) : Structure(pointer) {
    @JvmField var type: Uint32 = 0
    @JvmField var timestamp: Uint32 = 0
    @JvmField var which: SDL_JoystickID = 0
    @JvmField var axis: Uint8 = 0
    @JvmField var padding1: Uint8 = 0
    @JvmField var padding2: Uint8 = 0
    @JvmField var padding3: Uint8 = 0
    @JvmField var value: Sint16 = 0
    @JvmField var padding4: Uint16 = 0
...
open class SDL_ControllerButtonEvent(pointer: Pointer? = null) : Structure(pointer) {
    ...
    @JvmField var timestamp: Uint32 = 0
    @JvmField var which: SDL_JoystickID = 0
    @JvmField var button: Uint8 = 0
    @JvmField var state: Uint8 = 0
    @JvmField var padding1: Uint8 = 0
    @JvmField var padding2: Uint8 = 0
...
open class SDL_ControllerSensorEvent(pointer: Pointer? = null) : Structure(pointer) {
    ...
    @JvmField var timestamp: Uint32 = 0
    @JvmField var which: SDL_JoystickID = 0
    @JvmField var sensor: Sint32 = 0
    @JvmField var data = FloatArray(3)
...
open class SDL_ControllerTouchpadEvent(pointer: Pointer? = null) : Structure(pointer) {
    ...
    @JvmField var timestamp: Uint32 = 0
    @JvmField var which: SDL_JoystickID = 0
    @JvmField var touchpad: Sint32 = 0
    @JvmField var finger: Sint32 = 0
    @JvmField var x: Float = 0f
    @JvmField var y: Float = 0f
    @JvmField var pressure: Float = 0f
...
open class SDL_DisplayEvent(pointer: Pointer? = null) : Structure(pointer) {
    @JvmField var type: Uint32 = 0
    @JvmField var timestamp: Uint32 = 0
    @JvmField var display: Uint32 = 0
    @JvmField var event: Uint8 = 0
    @JvmField var padding1: Uint8 = 0
    @JvmField var padding2: Uint8 = 0
    @JvmField var padding3: Uint8 = 0
    @JvmField var data1: Sint32 = 0
...
open class SDL_DollarGestureEvent(pointer: Pointer? = null) : Structure(pointer) {
    @JvmField var type: Uint32 = 0
    @JvmField var timestamp: Uint32 = 0
    @JvmField var touchId: SDL_TouchID = 0
    @JvmField var gestureId: SDL_GestureID = 0
    @JvmField var numFingers: Uint32 = 0
...
open class SDL_DropEvent(pointer: Pointer? = null) : Structure(pointer) {
    ...
    @JvmField var windowID: Uint32 = 0
    class Ref(pointer: Pointer? = null) : SDL_DropEvent(pointer), ByReference
}

open class SDL_Event(pointer: Pointer? = null) : Union(pointer) {
    @JvmField var type: Uint32 = 0
    @JvmField var common = SDL_CommonEvent()
    @JvmField var display = SDL_DisplayEvent()
    @JvmField var window = SDL_WindowEvent()
    @JvmField var key = SDL_KeyboardEvent()
    @JvmField var edit = SDL_TextEditingEvent()
    @JvmField var text = SDL_TextInputEvent()
    @JvmField var motion = SDL_MouseMotionEvent()
    @JvmField var button = SDL_MouseButtonEvent()
    @JvmField var wheel = SDL_MouseWheelEvent()
    @JvmField var jaxis = SDL_JoyAxisEvent()
    @JvmField var jball = SDL_JoyBallEvent()
    @JvmField var jhat = SDL_JoyHatEvent()
    @JvmField var jbutton = SDL_JoyButtonEvent()
    @JvmField var jdevice = SDL_JoyDeviceEvent()
    @JvmField var caxis = SDL_ControllerAxisEvent()
    @JvmField var cbutton = SDL_ControllerButtonEvent()
    @JvmField var cdevice = SDL_ControllerDeviceEvent()
    @JvmField var ctouchpad = SDL_ControllerTouchpadEvent()
    @JvmField var csensor = SDL_ControllerSensorEvent()
    @JvmField var adevice = SDL_AudioDeviceEvent()
    @JvmField var sensor = SDL_SensorEvent()
    @JvmField var quit = SDL_QuitEvent()
    @JvmField var user = SDL_UserEvent()
    @JvmField var syswm = SDL_SysWMEvent()
    @JvmField var tfinger = SDL_TouchFingerEvent()
    @JvmField var mgesture = SDL_MultiGestureEvent()
    @JvmField var dgesture = SDL_DollarGestureEvent()
    @JvmField var drop = SDL_DropEvent()
    @JvmField var padding = ByteArray(56)
...
open class SDL_JoyBallEvent(pointer: Pointer? = null) : Structure(pointer) {
    ...
    @JvmField var timestamp: Uint32 = 0
    @JvmField var which: SDL_JoystickID = 0
    @JvmField var ball: Uint8 = 0
    @JvmField var padding1: Uint8 = 0
    @JvmField var padding2: Uint8 = 0
    @JvmField var padding3: Uint8 = 0
    @JvmField var xrel: Sint16 = 0
    @JvmField var yrel: Sint16 = 0
...
open class SDL_JoyHatEvent(pointer: Pointer? = null) : Structure(pointer) {
    ...
    @JvmField var timestamp: Uint32 = 0
    @JvmField var which: SDL_JoystickID = 0
    @JvmField var hat: Uint8 = 0
    @JvmField var value: Uint8 = 0
    @JvmField var padding1: Uint8 = 0
    @JvmField var padding2: Uint8 = 0
...
open class SDL_KeyboardEvent(pointer: Pointer? = null) : Structure(pointer) {
    ...
    @JvmField var windowID: Uint32 = 0
    @JvmField var state: Uint8 = 0
    @JvmField var repeat: Uint8 = 0
    @JvmField var padding2: Uint8 = 0
    @JvmField var padding3: Uint8 = 0
    @JvmField var keysym = SDL_Keysym()
...
open class SDL_MouseButtonEvent(pointer: Pointer? = null) : Structure(pointer) {
    ...
    @JvmField var button: Uint8 = 0
    @JvmField var state: Uint8 = 0
    @JvmField var clicks: Uint8 = 0
    @JvmField var padding1: Uint8 = 0
    @JvmField var x: Sint32 = 0
    @JvmField var y: Sint32 = 0
...
open class SDL_MouseMotionEvent(pointer: Pointer? = null) : Structure(pointer) {
    ...
    @JvmField var windowID: Uint32 = 0
    @JvmField var which: Uint32 = 0
    @JvmField var state: Uint32 = 0
    @JvmField var x: Sint32 = 0
    @JvmField var y: Sint32 = 0
    @JvmField var xrel: Sint32 = 0
    @JvmField var yrel: Sint32 = 0
...
open class SDL_MouseWheelEvent(pointer: Pointer? = null) : Structure(pointer) {
    ...
    @JvmField var x: Sint32 = 0
    @JvmField var y: Sint32 = 0
    @JvmField var direction: Uint32 = 0
...
open class SDL_MultiGestureEvent(pointer: Pointer? = null) : Structure(pointer) {
    ...
    @JvmField var timestamp: Uint32 = 0
    @JvmField var touchId: SDL_TouchID = 0
    @JvmField var dTheta: Float = 0f
    @JvmField var dDist: Float = 0f
    @JvmField var x: Float = 0f
    @JvmField var y: Float = 0f
    @JvmField var numFingers: Uint16 = 0
    @JvmField var padding: Uint16 = 0
...
open class SDL_SensorEvent(pointer: Pointer? = null) : Structure(pointer) {
    ...
    @JvmField var timestamp: Uint32 = 0
    @JvmField var which: Sint32 = 0
    @JvmField var data = FloatArray(6)
...
open class SDL_SysWMEvent(pointer: Pointer? = null) : Structure(pointer) {
    @JvmField var type: Uint32 = 0
    @JvmField var timestamp: Uint32 = 0
    @JvmField var msg: SDL_SysWMmsg? = null
...
open class SDL_TextEditingEvent(pointer: Pointer? = null) : Structure(pointer) {
    ...
    @JvmField var timestamp: Uint32 = 0
    @JvmField var windowID: Uint32 = 0
    @JvmField var text = CharArray(SDL_TEXTEDITINGEVENT_TEXT_SIZE)
    @JvmField var start: Sint32 = 0
    @JvmField var length: Sint32 = 0
...
open class SDL_TextInputEvent(pointer: Pointer? = null) : Structure(pointer) {
    ...
    @JvmField var timestamp: Uint32 = 0
    @JvmField var windowID: Uint32 = 0
    @JvmField var text = CharArray(SDL_TEXTINPUTEVENT_TEXT_SIZE)
...
open class SDL_TouchFingerEvent(pointer: Pointer? = null) : Structure(pointer) {
    ...
    @JvmField var timestamp: Uint32 = 0
    @JvmField var touchId: SDL_TouchID = 0
    @JvmField var fingerId: SDL_FingerID = 0
    @JvmField var x: Float = 0f
    @JvmField var y: Float = 0f
    @JvmField var dx: Float = 0f
    @JvmField var dy: Float = 0f
    @JvmField var pressure: Float = 0f
    @JvmField var windowID: Uint32 = 0
...
open class SDL_UserEvent(pointer: Pointer? = null) : Structure(pointer) {
    ...
    @JvmField var timestamp: Uint32 = 0
    @JvmField var windowID: Uint32 = 0
    @JvmField var code: Sint32 = 0
    @JvmField var data1: Pointer? = null
    @JvmField var data2: Pointer? = null
